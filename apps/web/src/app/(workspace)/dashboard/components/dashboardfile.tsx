  ...
  return (
    ...
    <div className="bg-gray-200 h-screen">
      <div className="h-[calc(100vh-4rem)] flex flex-col">
        <div className="bg-grey-200  h-[4rem] signup-bg flex px-5 border-gray-700/30 border-b">
          <Image
            ...
            <div className="h-[40vh] w-full py-2 flex flex-col justify-around items-start">
              ...
              <div className="flex flex-col w-3/5 mx-auto py-1 mt-3">
                <label
                  ...
                  id="workspacetitle"
                  className="font-bold mb-1 text-center text-black"
                >
                  Workspace Name
                </label>
                <input
                  id="workspacename"
                  placeholder="JD Robbin"
                  type="text"
                  autoCapitalize="none"
                  autoCorrect="off"
                  disabled={isLoading}
              ...
              <div className="flex flex-col w-3/5 mx-auto py-1 mt-3">
                ...
                <select
                  ...
                  className="select select-primary w-full max-w"
                  // onChange={(t) =>
                  //   setWorkspace({
                  //     ...workspace,
                  //     type: t.target.value,
